...
class ActivityRestauranteMickys : AppCompatActivity() {
    private lateinit var carouselRecyclerview: CarouselRecyclerview
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_restaurante_mickys)
    ...
    fun irAFacebook(view: View) {
        val uri = Uri.parse("https://www.facebook.com/Mickys American Broaster")
        val intent = Intent(Intent.ACTION_VIEW, uri)
        startActivity(intent)
    }
}
